...
class MagazinesControllerTest < ActionController::TestCase
  ...
  test "should create magazine" do
    assert_difference('Magazine.count') do
      post :create, magazine: { code: @magazine.code, num_page: @magazine.num_page, review: @magazine.review, source: @magazine.source, themes: @magazine.themes, title: @magazine.title }
    end
  ...
  test "should update magazine" do
    patch :update, id: @magazine, magazine: { code: @magazine.code, num_page: @magazine.num_page, review: @magazine.review, source: @magazine.source, themes: @magazine.themes, title: @magazine.title }
    assert_redirected_to magazine_path(assigns(:magazine))
  end
